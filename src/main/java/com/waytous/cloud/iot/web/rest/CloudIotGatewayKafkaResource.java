...
@RestController
@RequestMapping("/api/cloud-iot-gateway-kafka")
public class CloudIotGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CloudIotGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CloudIotGatewayKafkaResource(KafkaProperties kafkaProperties) {
